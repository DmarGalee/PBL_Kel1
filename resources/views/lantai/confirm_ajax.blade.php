            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <tr>
                            <th class="text-right col-3">Nomor Lantai :</th>
                            <td class="col-9">{{ $lantai->lantai_nomor }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Deskripsi :</th>
                            <td class="col-9">{{ $lantai->deskripsi }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Gedung :</th>
                            <td class="col-9">{{ $lantai->gedung->gedung_nama ?? '-' }}</td>
                        </tr>
                    </table>
                </div>
